...
cpSync(
  `${threePath}/build/three.module.min.js`,
  `${threeDestPath}/three.module.min.js`,
);
cpSync(
  `${threePath}/build/three.core.min.js`,
  `${threeDestPath}/three.core.min.js`,
);
cpSync(`${threePath}/examples/jsm`, `${threeDestPath}/examples/jsm`, {
  recursive: true,
});
...
cpSync(`${katexPath}/dist/fonts/`, `${katexDestPath}/fonts/`, {
  recursive: true,
});
cpSync(`${katexPath}/dist/contrib/`, `${katexDestPath}/contrib/`, {
  recursive: true,
});

const exprevalPath = "./node_modules/expr-eval/dist";
const exprevalDestPath = "./docs/js/vendor/";
cpSync(`${exprevalPath}/bundle.min.js`, `${exprevalDestPath}/expr-eval.min.js`);
